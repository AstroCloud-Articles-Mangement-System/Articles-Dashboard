            ...
            <div class="card-body row">
                <div class="form-group col-6">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="name" name="name" class="form-control vaildate_input" placeholder="Full Name" value="<?php echo $user[0]['user_name']; ?>" required>
                ...
                <div class="form-group col-6">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="user_name" name="user_name" class="form-control vaildate_input" placeholder="Username" value="<?php echo $user[0]['user_username']; ?>" required>
                ...
                <div class="form-group col-6">
                    <div class="input-group mb-3">
                        ...
                        <input type="email" class="form-control vaildate_input" id="email" name="email" placeholder="example@gmail.com" fdprocessedid="7re2y6" value="<?php echo $user[0]['user_email']; ?>" required>
                ...
                <div class="form-group col-6">
                    <div class="input-group mb-3">
                        ...
                        <input type="phone" id="phone" name="phone" class="form-control vaildate_input" placeholder="Phone Number" value="<?php echo '0'.$user[0]['user_mobile_number']; ?>" required>
                ...
                <div class="form-group col-12">
                    <div class="input-group mb-3">
                        ...
                        <input type="password" id="user_password" name="user_password" class="form-control vaildate_input" placeholder="Password" value="" required>
