        ...
        <form action="/groups" method="post" style="z-index: 5;" id="vaildate_group_form" data-form-type="edit">
            ...
            <div class="card-body row">
                ...
                <div class="form-group col-12">
                    ...
                    <div>
                        <textarea class="form-control vaildate_input" placeholder="Group Description" name="group_desc"
                            id="group_desc" rows="6" required><?php echo $group[0]['group_description']; ?>
                        </textarea>
                        <div class="alert alert-danger  px-3 py-2 mt-2 d-none w-100" role="alert"
